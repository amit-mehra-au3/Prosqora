...
export default function UserMenu() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <div className="w-7 h-7 rounded-lg bg-brand-orange/20 border border-brand-orange/40 text-brand-orange font-bold flex items-center justify-center text-xs">
          {initial}
        </div>
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-56 bg-industrial-900 border border-industrial-700 rounded-xl shadow-2xl py-2 z-50 animate-in fade-in zoom-in duration-100 text-xs">
          ...
          <div className="px-4 py-2 border-b border-industrial-800 space-y-0.5">
